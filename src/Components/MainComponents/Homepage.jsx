...
import './Home.css' ;
import { getHome , getCards , getFeedBack } from '../../services/Home/home.service';
const Homepage = () => {
    ...
    <div>
              ...
              <div className="box-container">
                <div className=''>
                  <div className="box">
                    ...
                    <p>"{feed.feed}"</p>
                    <div className="user">
                      <img src="https://thumbs.dreamstime.com/b/solid-purple-gradient-user-icon-web-mobile-design-interface-ui-ux-developer-app-137467998.jpg" alt="" />
      ...
      <div>
        <section className="footer">
          ...
          <div className="credit"> created by <span><i class="copyright icon"></i>Hamza</span> | all rights reserved </div>
