  ...
  return (
    <div className=''>
      ...
      <div className='container'>
        {
          posts.filter((item) =>
            item.title.toLowerCase().includes(value) || item.AuthorName.toLowerCase().includes(value)
          ).map(post => (
            <div key={post.id} className='card'>
              ...
              <p>Book Id : {post.id}</p>
              <Button className='blue' onClick={() => Edit(post.id)}>Edit Books</Button>
              <Button className='red' onClick={() => Delete(post.id)}>Delete Books</Button>
            </div>
          ))
        }
      </div>
